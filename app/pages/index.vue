      ...
      <UContainer>
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="tennis-card p-6 text-center">
            ...
            <p class="text-body mb-4">
              Die TuS-Tennisabteilung wünscht viel Glück und ein gesundes, verletzungsfreies Jahr 2025.
            </p>
            <NuxtLink
              to="/abteilung"
          ...
          <div class="tennis-card p-6 text-center">
            ...
            <p class="text-body mb-4">
              Unsere schöne Anlage bietet zwei Outdoor Tennisplätze sowie eine Tennishalle mit drei Spielfeldern.
            </p>
            <NuxtLink
              to="/anlagen"
              class="text-green-600 hover:text-green-700 font-medium"
