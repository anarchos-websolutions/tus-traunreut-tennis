<template>
  <section id="booking" class="py-20 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20">
    <UContainer>
      <!-- Section Header -->
      <div class="text-center mb-16">
        <UBadge color="green" variant="soft" size="lg" class="mb-4">
          Online Buchung
        </UBadge>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <UCard class="overflow-hidden">
          <template #header>
            <div class="bg-gradient-to-r from-green-500 to-blue-600 text-white p-6">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h3 class="text-2xl font-bold">Tennisplatz Buchen</h3>
                  <p class="opacity-90">Wählen Sie Ihren gewünschten Termin</p>
                </div>
              </div>
            </div>
          </template>
          ...
          <div class="space-y-6">
            ...
            <!-- Booking Summary -->
            <div v-if="selectedCourt && selectedDate && selectedTime && selectedDuration" 
                 class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Buchungsübersicht</h4>
              ...
              <div class="space-y-4">
                <div class="flex items-start space-x-3">
                  <div class="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon name="heroicons:device-phone-mobile" class="w-5 h-5 text-green-600" />
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white">Smartphone-optimiert</h4>
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white">24/7 verfügbar</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-300">
                ...
                <div class="flex items-start space-x-3">
                  <div class="w-10 h-10 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Icon name="heroicons:envelope" class="w-5 h-5 text-purple-600" />
                  </div>
                  <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white">Sofortige Bestätigung</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-300">
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white">Bessere Auslastung</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-300">
              ...
              <div class="space-y-3">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-300">info@tennis-traunreut.de</p>
                  </div>
                </div>
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-300">+49 (0) 8669 - 2971</p>
                  </div>
                </div>
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-300">Traunring 118, 83301 Traunreut</p>
                  </div>
                </div>
              </div>
            </div>
