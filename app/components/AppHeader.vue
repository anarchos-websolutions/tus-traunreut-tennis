    ...
    <UContainer>
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden xl:flex items-center space-x-6">
          ...
          <NuxtLink to="https://sportbuchung-traunreut.ebusy.de/" class="btn btn-primary" @click="mobileMenuOpen = false">
            Jetzt Buchen
          </NuxtLink>
        </nav>
         <!-- Mobile Menu Button -->
      ...
      <!-- Mobile Menu -->
      <div v-if="mobileMenuOpen && !isXLScreen" class="py-4 border-t border-gray-200">
